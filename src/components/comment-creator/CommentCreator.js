...
function CommentCreator({commentInputValue, postComment, writeComment, postId }) {
  const comment = {
    postId: postId,
  ...
  return (
    <div>
      <input type="text" onChange={(event) => writeComment(event.target.value)} value={commentInputValue}/>
